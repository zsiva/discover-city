    ...
    <section className="container intro">
      ...
      <div className="row">
        ...
        <div className="col-xs-12 col-sm-8 text-center">
          ...
          <p className="text-left">Our little lepprechaun O&apos;Greeny was chilling, having a cold Guiness while his money was stolen.</p>
          <p className="text-left">He has been looking all over the world for it but cannot find it. Help him!</p>
          <Button label="Find the gold!" onClick={props.handleClick}/>
        </div>
      </div>
    </section>
  );
